...
import com.prabandhah.prabandhah.ForgetPassNewPassword;
...
public class EmpList extends Fragment {
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {

        //Returning the layout file after inflating
        //Change R.layout.tab1 in you classes
        return inflater.inflate(R.layout.activity_emp_list, container, false);
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        // EditText etFoo = (EditText) view.findViewById(R.id.etFoo);
         recyclerView = view.findViewById(R.id.emplist_recycler);
             ...
             public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                 ...
                 reference.addValueEventListener(new ValueEventListener() {
                     ...
                     public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                         ...
                         counter = list.size();
                         adepterForRecylerView = new AdepterForRecylerView(getActivity().getApplicationContext(),list,"EmpList");
