...
public class EventMangerList extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.activity_event_manger_list, container, false);
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                reference.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        counter = list.size();
                        adepterForRecylerView = new AdepterForRecylerView(getActivity().getApplicationContext(), list,"EventManagerList");
