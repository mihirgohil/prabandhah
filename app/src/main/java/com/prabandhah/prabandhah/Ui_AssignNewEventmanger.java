...
public class Ui_AssignNewEventmanger extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fba.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                adepterForRecylerView.selectedlisteventManger();
                Intent intent = new Intent(getApplicationContext(), Ui_employeeList.class);
                finish();
                startActivity(intent);
            }
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                reference.addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        counter = list.size();
                        adepterForRecylerView = new AdepterForRecylerView(Ui_AssignNewEventmanger.this,list,Ui_AssignNewEventmanger.class.getSimpleName());
                        recyclerView.setAdapter(adepterForRecylerView);
                        Toast.makeText(Ui_AssignNewEventmanger.this, "c"+String.valueOf(counter), Toast.LENGTH_SHORT).show();
                    }
