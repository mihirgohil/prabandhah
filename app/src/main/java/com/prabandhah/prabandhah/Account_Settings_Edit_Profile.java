...
public class Account_Settings_Edit_Profile extends AppCompatActivity {
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!name.getText().toString().isEmpty()){
                    ...
                    Toast.makeText(Account_Settings_Edit_Profile.this, "User name can't be empty", Toast.LENGTH_SHORT).show();
                }
